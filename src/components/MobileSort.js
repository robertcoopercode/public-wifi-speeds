...
class MobileSort extends Component {
    ...
    render() {
        return (
            ...
            <div
                className={"summary-section__action-button dropdown dropdown--sort" + (this.state.showDropdown ? " is-active" : "")}
...
<i className="fa fa-angle-down" aria-hidden="true"></i>
                ...
                <div className="dropdown-menu" id="dropdown-menu" role="menu">
                    <div className="dropdown-content">
                        <a
                            className={"dropdown-item" + (this.props.sortField === 'timestamp' ? ' is-active' : '')}
                            onClick={() => this.selectSort("timestamp", false, "Most Recent")}>
                            Most Recent
                        </a>
                        <a
                            className={"dropdown-item" + (this.props.sortField === 'location' ? ' is-active' : '')}
                            onClick={() => this.selectSort("location", true, "Location (Alphabetical)")}>
                            Location (Alphabetical)
                        </a>
                        <a className={"dropdown-item" + (this.props.sortField === 'download' ? ' is-active' : '')}
                           onClick={() => this.selectSort("download", false, "Fastest Download")}>
                            Fastest Download
                        </a>
                        <a
                            className={"dropdown-item" + (this.props.sortField === 'upload' ? ' is-active' : '')}
                            onClick={() => this.selectSort("upload", false, "Fastest Upload")}>
                            Fastest Upload
                        </a>
                        <a
